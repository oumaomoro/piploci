...
class Settings(BaseSettings):
    ...
    BASE_CAPITAL_USD: float = float(os.getenv("BASE_CAPITAL_USD", "155.0"))
    DAILY_DRAWDOWN_LIMIT_USD: float = 4.50
    CIRCUIT_BREAKER_HALT_HOURS: int = 24
    RISK_PERCENT_PER_TRADE: float = 1.0  # 1% per trade
    TIER1_PROFIT_THRESHOLD: float = 15.0  # +15% net profit
    TIER2_PROFIT_THRESHOLD: float = 30.0  # +30% net profit
    DRAWDOWN_OVERRIDE_THRESHOLD_USD: float = 2.25  # 50% of $4.50 daily limit
...
BASE_CAPITAL_USD = settings.BASE_CAPITAL_USD
...
TIER1_PROFIT_THRESHOLD = settings.TIER1_PROFIT_THRESHOLD
TIER2_PROFIT_THRESHOLD = settings.TIER2_PROFIT_THRESHOLD
DRAWDOWN_OVERRIDE_THRESHOLD_USD = settings.DRAWDOWN_OVERRIDE_THRESHOLD_USD
